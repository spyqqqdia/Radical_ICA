...
true entropy of the distribution generating the samples. In the test cases the two estimators show similar performance,
...
it adapts itself to the distribution (Professor Learned-Miller, personal communication) and is fast when this is appropriate
and slow when needed. This remains to be implemented.
